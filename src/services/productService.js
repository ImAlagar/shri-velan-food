...
// services/productService.js - ADD THIS METHOD TO THE CLASS
async globalSearch(searchParams) {
  ...
  // Get search suggestions for related terms
  const searchSuggestions = await this.getSearchSuggestions(searchQuery);
